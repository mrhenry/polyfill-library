...
},{"whatwg-url":8}],3:[function(require,module,exports){
"use strict";
...
function mapChars(domainName, _ref2) {
  var useSTD3ASCIIRules = _ref2.useSTD3ASCIIRules,
    transitionalProcessing = _ref2.transitionalProcessing;
  var processed = "";
...
function validateLabel(label, _ref3) {
  var checkHyphens = _ref3.checkHyphens,
    ...
    transitionalProcessing = _ref3.transitionalProcessing,
...
function processing(domainName, options) {
  // 1. Map.
  var string = mapChars(domainName, options);
...
function toASCII(domainName) {
  var _ref4 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
    ...
    _ref4$transitionalPro = _ref4.transitionalProcessing,
    transitionalProcessing = _ref4$transitionalPro === void 0 ? false : _ref4$transitionalPro,
    _ref4$ignoreInvalidPu = _ref4.ignoreInvalidPunycode,
    ignoreInvalidPunycode = _ref4$ignoreInvalidPu === void 0 ? false : _ref4$ignoreInvalidPu;
...
function toUnicode(domainName) {
  var _ref5 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
    ...
    _ref5$transitionalPro = _ref5.transitionalProcessing,
    transitionalProcessing = _ref5$transitionalPro === void 0 ? false : _ref5$transitionalPro,
    _ref5$ignoreInvalidPu = _ref5.ignoreInvalidPunycode,
    ignoreInvalidPunycode = _ref5$ignoreInvalidPu === void 0 ? false : _ref5$ignoreInvalidPu;
  var result = processing(domainName, {
    checkHyphens: checkHyphens,
    checkBidi: checkBidi,
    checkJoiners: checkJoiners,
...
},{"./lib/mappingTable.json":4,"./lib/regexes.js":5,"./lib/statusMapping.js":6,"punycode/":1}],4:[function(require,module,exports){
...
var _require = require("./webidl2js-wrapper"),
  URL = _require.URL,
  URLSearchParams = _require.URLSearchParams;
var urlStateMachine = require("./lib/url-state-machine");
var percentEncoding = require("./lib/percent-encoding");
...
},{"./lib/percent-encoding":16,"./lib/url-state-machine":17,"./webidl2js-wrapper":20}],9:[function(require,module,exports){
"use strict";
...
},{"./utils.js":19,"webidl-conversions":7}],10:[function(require,module,exports){
"use strict";
...
},{"./URLSearchParams":13,"./url-state-machine":17,"./urlencoded":18}],11:[function(require,module,exports){
"use strict";
...
},{"./URL-impl.js":10,"./utils.js":19,"webidl-conversions":7}],12:[function(require,module,exports){
"use strict";
...
},{"./urlencoded":18}],13:[function(require,module,exports){
"use strict";
...
},{"./Function.js":9,"./URLSearchParams-impl.js":12,"./utils.js":19,"webidl-conversions":7}],14:[function(require,module,exports){
"use strict";
...
},{"./encoding":14,"./infra":15}],17:[function(require,module,exports){
"use strict";
...
},{"./encoding":14,"./infra":15,"./percent-encoding":16,"tr46":3}],18:[function(require,module,exports){
"use strict";
...
},{"./encoding":14,"./percent-encoding":16}],19:[function(require,module,exports){
"use strict";

// Returns "Type(value) is Object" in ES terminology.
var _Object$getOwnPropert, _Object$getOwnPropert2, _Object$getOwnPropert3;
function _slicedToArray(r, e) { return _arrayWithHoles(r) || _iterableToArrayLimit(r, e) || _unsupportedIterableToArray(r, e) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function _arrayWithHoles(r) { if (Array.isArray(r)) return r; }
...
var AsyncIteratorPrototype = null;
...
var byteLengthGetter = (_Object$getOwnPropert = (_Object$getOwnPropert2 = Object.getOwnPropertyDescriptor(ArrayBuffer.prototype, "byteLength")) === null || _Object$getOwnPropert2 === void 0 ? void 0 : _Object$getOwnPropert2.get) !== null && _Object$getOwnPropert !== void 0 ? _Object$getOwnPropert : (_Object$getOwnPropert3 = Object.getOwnPropertyDescriptor(new Uint8Array(), "byteLength")) === null || _Object$getOwnPropert3 === void 0 ? void 0 : _Object$getOwnPropert3.get;
...
var URLSearchParams = require("./lib/URLSearchParams");
exports.URL = URL;
exports.URLSearchParams = URLSearchParams;

},{"./lib/URL":11,"./lib/URLSearchParams":13}]},{},[2]);
