 ...
 * @returns {Promise<Object.<string, string[]>} A promise which resolves with an object mapping all the aliases within the collection to the polyfills they include.
 */
 ...
 * @property {Object.<string, string>} browsers
 * @property {Object.<string, string | string[]>} install
 */
/**
 ...
 * @param {Object.<string, FlagMap>} [options_.features={}] - Which features should be returned if the user-agent does not support them natively.
 * @param {false | string} [options_.callback=false] - Name of the JavaScript function to call after the polyfill bundle is loaded.
 * @param {string[]} [options_.excludes=[]] - Which features should be excluded from the returned object.
 ...
 * @return {Promise<string | Readable>} - Polyfill bundle as either a utf-8 stream or a promise of a utf-8 string.
 */
