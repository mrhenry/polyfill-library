...
/**
 * @typedef {(path: string, options: "utf-8") => Promise<string>} readFile
 * @typedef {(path: string, options: { encoding: "utf-8" }) => import('stream').Readable} createReadStream
 *
 * @typedef {Object} FilesystemImplementation
